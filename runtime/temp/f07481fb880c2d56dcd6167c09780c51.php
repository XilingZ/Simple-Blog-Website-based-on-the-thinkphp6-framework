<?php /*a:1:{s:40:"C:\tp6_blog\app\view\admins\article.html";i:1620121399;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <ol class="breadcrumb">
        <li><a href="article_add">增加文章</a></li>
      </ol>
        ...
        <table class="table table-striped table-hover">
          <thead>
            <tr>
              ...
              <th class="hidden-sm"><span class="glyphicon glyphicon-tag"></span> <span class="visible-lg">作者</span></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="article-title"><?php echo htmlentities($v['article_title']); ?></td>
              <!--这里也可以通过模型关联，关联查询，原生的是在控制层写-->
              <td>
              <?php foreach($category as $w): if($v['cate_id']==$w['cate_id']): ?><?php echo htmlentities($w['cate_name']); ?><?php endif; ?>
              <?php endforeach; ?>
              </td>
              <td class="hidden-sm"><?php echo htmlentities($v['article_writer']); ?></td>
              <td class="hidden-sm">0</td>
              <td><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($v['article_time'])? strtotime($v['article_time']) : $v['article_time'])); ?></td>
              <td>
                <a href="article_edit.html?article_id=<?php echo htmlentities($v['article_id']); ?>">修改</a> 
                <a href="article_del?article_id=<?php echo htmlentities($v['article_id']); ?>">删除</a>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>

<?php /*a:1:{s:46:"C:\tp6_blog\app\view\admins\category_edit.html";i:1620121460;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <div class="form-group">
        ...
        <input type="text" id="cate_name" value="<?php echo htmlentities($cate['cate_name']); ?>" class="form-control" required autocomplete="off">
        <input type="hidden" id="cate_id" value="<?php echo htmlentities($cate['cate_id']); ?>" class="form-control" required autocomplete="off">
      </div>

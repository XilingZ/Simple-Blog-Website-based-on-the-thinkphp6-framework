<?php /*a:1:{s:37:"C:\tp6_blog\app\view\lists\index.html";i:1620191610;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="gb2312">
  ...
  <nav id="nav">
    <ul>
      ...
      <?php foreach($category as $v): ?>
        <li><a href="/Lists/index?cate_id=<?php echo htmlentities($v['cate_id']); ?>" target="_blank" title="<?php echo htmlentities($v['cate_name']); ?>"><?php echo htmlentities($v['cate_name']); ?></a></li>
      <?php endforeach; ?>
    </ul>
...
<a href="/jstt/div/2013-08-10/576.html" target="_blank" title=" li列表在网页中常见应用例举（二）"><img src="http://tp6.blog.ca/static/frontstage/images/s1.jpg" class="imgdow" alt=" li列表在网页中常见应用例举（二）"></a> <p class="pcon">li列表加时间，li列表背景图片的应用，li标签里面的span应该放在前面，如果放在后面IE浏览器较低版本会出现错位 <a href="/jstt/div/2013-08-10/576.html" target="_blank" title=" li列表在网页中常见应用例举（二）">详细信息</a></P>
<div class="line"></div>

<p class="ptit"><b><a href="/jstt/div/2013-08-10/575.html" target="_blank" title="li列表在网页中常见应用例举（一）">li列表在网页中常见应用例举（一）</a></b></p>
<p class="ptime">发布时间：2013-08-10 作者：杨青  分类：div+css </p>
<a href="/jstt/div/2013-08-10/575.html" target="_blank" title="li列表在网页中常见应用例举（一）"><img src="http://tp6.blog.ca/static/frontstage/images/s2.jpg" class="imgdow" alt="li列表在网页中常见应用例举（一）"></a> <p class="pcon">li在网页中的应用,list-style-type,设置或检索对象的列表项所使用的预设标记。list-style-image：属性使用图像来替换列表项的标记,li列表前面用图片来展示.注意：ol对象和ul对象的type特性为其后的所有列表项目（如li对象）指明列表属性。 <a href="/jstt/div/2013-08-10/575.html" target="_blank" title="li列表在网页中常见应用例举（一）">详细信息</a></P>
<div class="line"></div>
...
<a href="/jstt/bj/2013-08-06/570.html" target="_blank" title="帝国cms怎样修改列表分页函数"><img src="http://tp6.blog.ca/static/frontstage/images/s3.jpg" class="imgdow" alt="帝国cms怎样修改列表分页函数"></a> <p class="pcon">修改帝国默认的列表分页样式和伪静态页面留言版的分页样式。本来想在默认的模板标签上修改，看了看代码，b和a标签前后都多了空格，如果在现在的基础上改，简单改改也行，不过实在是受不了那么多空格符，而且如果用display:block的话... <a href="/jstt/bj/2013-08-06/570.html" target="_blank" title="帝国cms怎样修改列表分页函数">详细信息</a></P>
<div class="line"></div>
...
<a href="/jstt/div/2013-08-03/549.html" target="_blank" title="html css 十一条网页设计经典实用的代码片段"><img src="http://tp6.blog.ca/static/frontstage/images/s4.jpg" class="imgdow" alt="html css 十一条网页设计经典实用的代码片段"></a> <p class="pcon">这十一条网页设计经典实用的代码片段，在网站的应用中都比较广泛。方便快速的查阅以及建设一个新的页面，非常适合刚接触的web前端设计。包括设置一些字体、站点链接、IE6bug的处理，导航菜单以及高亮显示菜单，还有表单的一些设计... <a href="/jstt/div/2013-08-03/549.html" target="_blank" title="html css 十一条网页设计经典实用的代码片段">详细信息</a></P>
<div class="line"></div>
...
<a href="/jstt/div/2013-07-31/532.html" target="_blank" title="Fieldset教你如何绘制带标题的表单框"><img src="http://tp6.blog.ca/static/frontstage/images/s5.jpg" class="imgdow" alt="Fieldset教你如何绘制带标题的表单框"></a> <p class="pcon">一朋友问我像这样的表单样式是怎么实现的，我看到图，第一眼的印象应该是用图片来实现的，或者是用postion来定位实现的。本例演示如何在数据周围绘制一个带标题的框。 <a href="/jstt/div/2013-07-31/532.html" target="_blank" title="Fieldset教你如何绘制带标题的表单框">详细信息</a></P>
<div class="line"></div>
...
<div class="page"><a title="Total record"><b>38</b></a><b>1</b><a href="/jstt/index_2.html">2</a><a href="/jstt/index_2.html">></a><a href="/jstt/index_2.html">>></a></div>
    ...
    <aside>
      ...
      <div class="toppic">
        <h2>图文并茂</h2>
        <ul>
          <li><a href="/"><img src="http://tp6.blog.ca/static/frontstage/images/k01.jpg">腐女不可怕，就怕腐女会画画！
            <p>伤不起</p>
            </a></li>
          <li><a href="/"><img src="http://tp6.blog.ca/static/frontstage/images/k02.jpg">问前任，你还爱我吗？无限戳中泪点~
            <p>感兴趣</p>
            </a></li>
          <li><a href="/"><img src="http://tp6.blog.ca/static/frontstage/images/k03.jpg">世上所谓幸福，就是一个笨蛋遇到一个傻瓜。
            <p>喜欢</p>
            </a></li>
        </ul>
      </div>
...
<footer>
  <div class="footer-mid">
    ...
    <div class="visitors">
      ...
      <dl>
        <dt><img src="http://tp6.blog.ca/static/frontstage/images/s7.jpg">
        <dt>
        <dd>yisa
          <time>2小时前</time>
        </dd>
      ...
      <dl>
        <dt><img src="http://tp6.blog.ca/static/frontstage/images/s6.jpg">
        <dt>
        <dd>小林博客
          <time>8月7日</time>
        </dd>

<?php /*a:1:{s:43:"C:\tp6_blog\app\view\admins\admin_list.html";i:1620121430;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href='admin_edit?admin_id=<?php echo htmlentities($v['admin_id']); ?>'>修改</a> <a href='admin_del?admin_id=<?php echo htmlentities($v['admin_id']); ?>'>删除</a> <a href="/User/checked/id/1/action/n">禁用</a></td>
              </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
  ...
  <div class="modal-dialog" role="document" style="max-width:450px;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table" style="margin-bottom:0px;">
          ...
          <tbody>
            <tr>
              <td wdith="20%">用户名:</td>
              <td width="80%"><input type="text" id="adminName" class="form-control" maxlength="10" autocomplete="off" /></td>
            </tr>
            <tr>
              <td wdith="20%">密码:</td>
              <td width="80%"><input type="password" id="password" class="form-control"  maxlength="18" autocomplete="off" /></td>
            </tr>
          </tbody>
          <tfoot>
            <tr></tr>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="addAdmin" class="btn btn-primary">提交</button>
      </div>
    </div>
  </div>
</div>

<?php /*a:1:{s:41:"C:\tp6_blog\app\view\admins\category.html";i:1620121477;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-md-5">
          ...
          <div class="form-group">
            ...
            <input type="text" id="categoryName" class="form-control" required autocomplete="off">
          </div>
          <button class="btn btn-primary" type="button" id="addCategory">添加新栏目</button>
        </div>
        <div class="col-md-7">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td><?php echo htmlentities($v['cate_id']); ?></td>
                  <td><?php echo htmlentities($v['cate_name']); ?></td>
                  <td>web</td>
                  <td>125</td>
                  <td><a href="category_edit.html?cate_id=<?php echo htmlentities($v['cate_id']); ?>">修改</a> <a href="category_del?cate_id=<?php echo htmlentities($v['cate_id']); ?>">删除</a></td>
                </tr>
                <?php endforeach; ?>
              </tbody>
            </table>

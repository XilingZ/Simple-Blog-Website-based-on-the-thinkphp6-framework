<?php /*a:1:{s:45:"C:\tp6_blog\app\view\admins\article_edit.html";i:1620121452;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
        ...
        <form action="edit" method="post" enctype="multipart/form-data">
          <div class="col-md-9">
            ...
            <div class="form-group">
              ...
              <input type="text" id="article_title" name="article_title" value="<?php echo htmlentities($article['article_title']); ?>" class="form-control" >
              <input type="hidden" name="article_id" value="<?php echo htmlentities($article['article_id']); ?>">
            </div>
            <div class="form-group">
              <h2 class="add-article-box-title"><span>作者</span></h2>
              <input type="text" id="author" name="author"  value="<?php echo htmlentities($article['article_writer']); ?>" class="form-control" >
            </div>
            <div class="form-group">
              <h2 class="add-article-box-title"><span>内容</span></h2>
              <td>
                <div id="div1">
                  <p><?php echo htmlentities($article['article_content']); ?></p>
                </div>
          ...
          <div class="col-md-3">
                ...
                <ul class="category-list">
                  <select id="category" name="category">
                    <?php foreach($category as $v): if($v['cate_id'] == $article['cate_id']): ?>
                      <option value='<?php echo htmlentities($v['cate_id']); ?>' selected="selected"><?php echo htmlentities($v['cate_name']); ?></option>
                      <?php else: ?>
            ...
            <button class="btn btn-primary" type="submit" id="edit">修改博文</button>
          </div>
        </form>
      </div>
    </div>
...
<script src="http://tp6.blog.ca/static/admin/js/wangEditor.js"></script>
